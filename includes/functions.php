			...
			<?php if ($skip_views === 'no') { ?>
				<li>
					<a href="javascript:;">
						...
						<span><?php echo intval($question_views); ?>&nbsp;<?php esc_html_e('views', 'cannalisting_core'); ?></span>
					</a>
				</li>
			<?php } ?>
            <li>
                <a href="javascript:;">
                    ...
                    <span><?php printf( _x( '%s Ago', '%s = human-readable time difference', 'cannalisting_core' ), human_time_diff( get_the_time( 'U' ), current_time( 'timestamp' ) ) ); ?></span>
                </a>
            </li>
        </ul>
        <?php
        ...
        <ul class="tg-votesanswers">
            <li>
                <a href="javascript:;">
                    ...
                    <em><?php esc_html_e('votes', 'cannalisting_core'); ?></em>
                </a>
            </li>
            ...
            <?php if ($skip_ans === 'no') { ?>
                <li>
                    <a href="javascript:;">
                        ...
                        <em><?php esc_html_e('answers', 'cannalisting_core'); ?></em>
                    </a>
                </li>
        <?php } ?>
        </ul>
