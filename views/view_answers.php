...
<div class="tg-companyfeaturebox tg-answers" data-q_id="<?php echo intval( $ques_id );?>">
	<div class="tg-companyfeaturetitle">
		<h3><?php esc_html_e('Answers', 'cannalisting_core'); ?></h3>
	</div>
	<?php if ($q_query->have_posts()) {?>
		...
		<?php if( $total_posts > $posts_per_page ){?>
			<div class="tg-haslayout loadmore-wrap">
				<a class="loadmore_a tg-btn"><?php esc_html_e('Load more..', 'cannalisting_core'); ?></a>
			</div>
        <?php }?>
	<?php } else{?>
		<p><?php esc_html_e('No answered yet.', 'cannalisting_core'); ?></p>
	<?php }?>
</div>
